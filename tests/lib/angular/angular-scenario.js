...
jQuery.extend({
	...
	// Convert dashed to camelCase; used by the css and data vevo_modules
...
// AMD vevo_modules. A named AMD is safest and most robust way to register.
 ...
 * @param {Array<String|Function>=} modules an array of module declarations. See: {@link angular.module vevo_modules}
 ...
 * @description
 *
 * Interface for configuring angular {@link angular.module vevo_modules}.
 */
...
function setupModuleLoader(window) {
  ...
  return ensure(ensure(window, 'angular', Object), 'module', function() {
     ...
     * @description
     *
     * The `angular.module` is a global place for creating and registering Angular vevo_modules. All
     * vevo_modules (angular core or 3rd party) that should be available to an application must be
     ...
     * </pre>
     *
     * Then you can create an injector and load your vevo_modules like this:
     *
     * <pre>
    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           * @description
           * Holds the list of vevo_modules which the injector will load before the current module is loaded.
           */
          requires: requires,
 ...
 * into configuration function (other vevo_modules) and it is not interceptable by

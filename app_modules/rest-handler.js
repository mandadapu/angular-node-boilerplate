...
exports.handle = function(host, port, url, paramDefaults, actions) {
    var api = {};
    api.url = url;
    api.paramDefaults = paramDefaults;

    // common
    var createPath = function(url, param, query) {
    ...
    // default actions
    var get = function(param, query, success, failure) {
        var options = {
            host: host,
            port: port,
            path: createPath(url, param, query),
            method: 'GET',
